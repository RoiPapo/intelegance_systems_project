 ...
 jQuery(document).ready(function($) {
	...
	function containsOnlyNumbers(str) {
 	...
 	"use strict";
	 var img_num = getUrlParameter('img')
	 console.log(img_num)
	 if(containsOnlyNumbers(img_num)){
		console.log("img_num")
		console.log("/images/img_"+img_num+".jpg")
	 ...
	 $.fancybox.defaults.btnTpl.delete = '<button data-fancybox-delete class="fancybox-button fancybox-button--play" title="title of the icon">Edit</button>';
